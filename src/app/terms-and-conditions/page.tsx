...
import { FaFileContract, FaKey, FaCreditCard, FaBalanceScale, FaUserShield, FaServer, FaChevronRight, FaClipboardList } from "react-icons/fa";
...
const termsSections = [
  {
    ...
    icon: FaFileContract,
    points: [
      "Guard Monitor & Manage Sdn Bhd (herein after referred as Monitor & Manage) hereby agrees to provide the service by way of (Monitor & Manage App) Application (herein after referred to as The Mobile App/Web Portal) to the User once the User has subscribed as specified and defined in the Form.",
      ...
      "Unless otherwise expressly agreed in writing and/or as specified in the applicable laws, the Security Company and/or Property Management may only use and/or apply the services provided by the Monitor & Manage through the Mobile App and/or Web Portal in accordance to the Malaysian applicable laws and for the use and lawful purpose only. The user is neither permitted to sell, resell, hire, lease (extending to sub lease), rent, offer, licence (extending to sub-licence) the service and/or any portion thereto whether for consideration or otherwise to any third party and/or unauthorised persona for any unlawful, illegal, fraudulent, improper use in breach of any applicable laws and/or regulations, notwithstanding tampering, altering, adjusting, removing abusing and/or affecting the App and/or its services.",
      "In the event of any disputes arising from using the Mobile App/web portal, the governing laws will be Malaysian Laws. In any legal proceedings commenced by Monitor & Manage against the Security Company and/or Property Management, all legal costs and/or expenses incurred by Monitor & Manage as a result of a legal proceedings shall be recovered from the User.",
  ...
  },
  {
    ...
    points: [
      ...
      "By selecting the option for payment 6 months once, the company shall provide discount of 5% amounting to RM 37.90 and by selecting the option for payment 12 months once, the company shall provide a discount of 10% amounting to RM 35.90. These discounts are applicable to both Web Portal Users and also Mobile App Users.",
      "All payments by the User to Monitor & Manage must be made within two (2) weeks of issuance of the invoice. In the event the user decides to dis-continue the service provided by the App/Web Portal and or make payment as required by Monitor & Manage after completion of the trial period, the user’s access and or profile will be restricted and or blocked and or deactivated and or deleted. All costs to reactivate the users access and or profile shall be borne by the user.",
  ...
  },
  {
    ...
    points: [
      ...
      "Working and patrolling schedule can only be created by Security Company and/or Branch Manager, the created schedules will take twenty-four (24) hours to appear and/or reflect in the App and/or system. Monitor & Manage will not be held responsible to amend and/or vary and/or modify and/or delete the schedules."
    ]
  },
  {
